// server/data/products.js  — CJS mirror of src/data/products.js
// Keep in sync manually (or replace both with a shared JSON file later).
'use strict'

const PRODUCTS = [
  {
    id:'pk-001', name:'Kullu Valley Shawl', price:2499, category:'shawl',
    origin:'Kullu, Himachal Pradesh', badge:'Bestseller', inStock:true,
    material:'Pure Himalayan wool — hand-spun and naturally dyed',
    dimensions:'200 cm × 100 cm · weight approx. 380 g',
    care:'Hand wash in cold water with mild soap. Dry flat in shade. Do not wring.',
    description:'Hand-woven on traditional pit looms passed down through generations, this pure wool shawl carries the iconic bold geometric patterns — the "Kullu buti" — that have defined Himachali textile identity for centuries. Each shawl takes a skilled weaver three to five days to complete. The tightly woven twill structure traps air efficiently, making it warm in the mountains yet breathable in milder weather. No two pieces are identical.',
    images: [
  ...
  {
    id:'pk-002', name:'Kinnauri Striped Muffler', price:899, category:'muffler',
    origin:'Kinnaur, Himachal Pradesh', badge:'New Arrival', inStock:true,
    material:'Angora-blend wool (70% wool, 30% Angora) — hand-woven',
    dimensions:'170 cm × 28 cm · weight approx. 120 g',
    care:'Dry clean recommended. If hand-washing, use cold water; reshape and dry flat.',
    description:'The distinctive burgundy, ivory, and mustard stripe of Kinnaur is one of the most recognisable weaving signatures in all of Himachal Pradesh. This muffler is crafted from an Angora-blend that gives it an exceptionally soft hand-feel while maintaining the structural integrity needed to hold the crisp stripe pattern.',
    images: [
  ...
  {
    id:'pk-003', name:'Spiti Hand-Knit Woolen Socks', price:349, category:'socks',
    origin:'Spiti Valley, Himachal Pradesh', badge:null, inStock:true,
    ...
    description:'At 3,800 metres above sea level, Spiti winters are unforgiving — and these socks were designed for exactly that. Knitted by artisan women of the Spiti high desert cooperatives using thick, unbleached local wool, they are structured with a reinforced heel and toe for durability and a ribbed cuff that keeps them in place all day.',
    images: [
  ...
  {
    id:'pk-004', name:'Chamba Embroidered Stole', price:1799, category:'stole',
    origin:'Chamba, Himachal Pradesh', badge:'Artisan Pick', inStock:true,
    material:'Pashmina-blend base (60% pashmina, 40% silk) with silk embroidery thread',
    dimensions:'190 cm × 70 cm · weight approx. 160 g',
    care:'Dry clean only. Store folded in a muslin cloth away from direct light.',
    description:'The "Chamba Rumal" is a UNESCO-recognised embroidery tradition — a double-sided chain stitch in silk thread so precise that both faces of the fabric are equally finished. This stole adapts the ancient motifs into a contemporary wearable form on a gossamer pashmina-silk base. Each stole is the work of a single artisan over two to three weeks.',
    images: [
  ...
  {
    id:'pk-005', name:"Manali Shepherd's Cap", price:599, category:'cap',
    origin:'Manali, Himachal Pradesh', badge:null, inStock:true,
    ...
    description:'Known locally as the "Himachali topi," this cap has been worn by shepherds and farmers of the Kullu-Manali corridor for as long as anyone can remember. Felting is done by hand — pressing and shrinking wet wool fibres until they lock permanently. The result is a cap that sheds light rain, holds its shape indefinitely, and improves with age.',
    images: [
...
// Attach imageUrl alias so API consumers don't have to know about images[0]
module.exports = PRODUCTS.map(p => ({ ...p, imageUrl: p.images[0] }))
