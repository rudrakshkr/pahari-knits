...
export const PRODUCTS = [
  withImageUrl({
    ...
    description:
      'Hand-woven on traditional pit looms, this pure wool shawl features iconic "Kullu buti" geometric patterns. A skilled artisan takes days to complete each unique piece, creating a breathable yet warm layer that defines Himachali textile heritage.',
    images: [
  ...
  withImageUrl({
    ...
    description:
      'Featuring the distinctive stripes of the Baspa Valley, this Angora-blend muffler offers exceptional softness and warmth. Each piece is hand-finished with knotted fringes, maintaining a crisp pattern that is lightweight yet incredibly durable.',
    images: [
  ...
  withImageUrl({
    ...
    description:
      'Knitted by artisan women in the Spiti high desert, these thick socks are crafted from unbleached local wool for sub-zero protection. Naturally moisture-resistant and reinforced for durability, they are a winter essential for extreme cold.',
    images: [
  ...
  withImageUrl({
    ...
    description:
      'Adapting UNESCO-recognized embroidery, this gossamer pashmina-silk stole features precise double-sided silk motifs. Dyed with local botanicals, each piece represents weeks of intricate hand-stitching by master artisans in Chamba.',
    images: [
  ...
  withImageUrl({
    ...
    description:
      'The traditional "Himachali topi" crafted from dense felted wool. This weather-resistant cap features iconic geometric banding and a structured hand-blocked finish, offering timeless mountain style that improves with age.',
    images: [
  ...
  withImageUrl({
    ...
    description:
      'A technical masterpiece, this reversible double-weave shawl features inverted colors on each side. Woven from fine merino wool by a heritage family in Rampur, it is one of the rarest examples of high-level Himachali handloom.',
    images: [
